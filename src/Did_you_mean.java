...
public class Did_you_mean {
    ...
    public static String did_you_mean(String query,SpellChecker spellChecker) throws IOException {
        String true_query="";
        ...
        for(int i=0;i<QWs.length;i++)
        {
            if(!QWs[i].equals(""))
            {
                String true_word=get_did_you_mean(QWs[i],spellChecker);
    ...
    public static String get_did_you_mean(String QW,SpellChecker spellChecker) throws IOException {
       String result="";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Did_you_mean.did_you_mean("mathmatical moments",spellChecker));
